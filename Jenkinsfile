   ...
   stages {
       ...
       stage('Deploy') {
           steps {
               ...
               sh 'cf push Product --random-route -p /Users/karimabounassif/BootCamp/AmazonMicro/applications/product/build/libs/product-0.0.1-SNAPSHOT.jar'
               sh 'cf push Shipment --random-route -p /Users/karimabounassif/BootCamp/AmazonMicro/applications/shipment/build/libs/shipment-0.0.1-SNAPSHOT.jar'
           }
       }
   }
}